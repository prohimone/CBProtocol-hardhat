...
contract VaultPair is BoringOwnable {
    ...
    // // Settings for the Medium Risk KashiPairs
    ...
    constructor(IVaultPairData _vaultPairData) public {
        // bentoBox = bentoBox_;
        console.log("VaultPair Constructor");
        vaultPairData = _vaultPairData;
        masterContract = this;
    }

    function getFromVaultPairData() external view returns(uint256,uint256){
        return (vaultPairData.CLOSED_COLLATERIZATION_RATE(), vaultPairData.OPEN_COLLATERIZATION_RATE());
    }
